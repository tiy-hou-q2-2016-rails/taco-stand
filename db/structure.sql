...
--
-- Name: tacos; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: tacos_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE tacos_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tacos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE tacos_id_seq OWNED BY tacos.id;
...
ALTER TABLE ONLY tacos ALTER COLUMN id SET DEFAULT nextval('tacos_id_seq'::regclass);
...
--
-- Name: tacos_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY tacos
...
INSERT INTO schema_migrations (version) VALUES ('20160628153034');

INSERT INTO schema_migrations (version) VALUES ('20160629163034');

INSERT INTO schema_migrations (version) VALUES ('20160629163501');

INSERT INTO schema_migrations (version) VALUES ('20160629170420');

INSERT INTO schema_migrations (version) VALUES ('20160630150206');

INSERT INTO schema_migrations (version) VALUES ('20160630163740');

INSERT INTO schema_migrations (version) VALUES ('20160707191823');
